...
```js
import { RiotApi, Constants } from "vladimir";
...
```js
import { LolApi, Constants } from "vladimir";
...
```js
import { TftApi, Constants } from "vladimir";
...
[More examples](https://github.com/Sansossio/vladimir/tree/master/example)

# Automatic rate limits reattempts

```js
import { LolApi } from 'vladimir'
...
This repository is a fork for our project purposes, If you want to use a more generic version, please take a look and use [twisted](https://github.com/Sansossio/twisted) instead.
